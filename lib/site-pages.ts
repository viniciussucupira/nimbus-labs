    ...
    blocks: [
      {
        ...
        rows: [
          ...
          ["Where you see your money", "Their Income tab. A Stripe Custom account has no Stripe login", "stripe.com, like any other business of yours. Not open to new stores yet"],
    ...
    blocks: [
      ...
      },
      {
        ...
        rows: [
          ...
          ["Whose payment account", "Your own Stripe or PayPal", "Your own Stripe. Not open to new stores yet"],
          ["Ways to be paid", "Stripe or PayPal", "Stripe only — we are behind them here"],
          ["When the money reaches you", "At the moment of sale, into your own account", "At the moment of sale, into your own account. Not open to new stores yet"],
    ...
    blocks: [
      ...
      },
      {
        ...
        rows: [
          ...
          ["Whose Stripe account", "One managed by the platform", "Yours. Proved in the demo store, and not open to new stores yet"],
          ["Getting paid", "Manual cash-out, $10 minimum", "Your Stripe payout schedule. Not open to new stores yet"],
          ["Klarna and Afterpay", "Yes, on the $99 plan", "Accepted by Stripe on the demo checkout. Not open to new stores yet"],
    ...
    blocks: [
      {
        ...
        items: [
          { title: "Can I sign up and sell today?", body: "You can sign up, take your store address and put what you sell on the page, today. You cannot be paid: nothing here can charge a card for your store yet, and your page says so to anyone who opens it. What proves the selling itself works is the demo store, which you can buy from with a Stripe test card." },
